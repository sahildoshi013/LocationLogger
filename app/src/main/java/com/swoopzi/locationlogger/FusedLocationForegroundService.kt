...
class FusedLocationForegroundService : Service() {
        ...
        override fun onLocationResult(locationResult: LocationResult) {
            ...
            locationResult.lastLocation?.let { location ->
                val providerType = when {
                    location.provider.equals(LocationManager.GPS_PROVIDER, ignoreCase = true) -> "GPS"
                    location.provider.equals(LocationManager.NETWORK_PROVIDER, ignoreCase = true) -> "Network"
                    location.provider.equals(LocationManager.PASSIVE_PROVIDER, ignoreCase = true) -> "Passive"
                    else -> "Unknown"
                }
                Log.d(TAG, "onLocationResult: $providerType")
